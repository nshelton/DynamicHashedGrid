...
public class RunCompute : MonoBehaviour
{
    ...
    void InitComputeShader()
    {
        ...
        mComputeShaderKernelID = computeShader.FindKernel("Integrate");

        // bind the compute buffer to the shader and the compute shader
        computeShader.SetBuffer(mComputeShaderKernelID, "_particleBuffer", particleBuffer);
    ...
    void Update()
    {
        ...
        computeShader.SetFloats("_mousePosition", mousePosition2D);
